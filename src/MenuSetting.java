...
public class MenuSetting {
	...
	public static String appId = "wxe7ff3381d3a16a27";
    public static String appSecret= "a2d86468e4ba88e227df5dcf802934f8"; 
    ...
    public static void add() throws JSONException{
        ...
        String json = "{"
                ...
                + "\"type\":\"view\","
                + "\"name\":\"开始答题\","
                + "\"url\":\"http://d73ntq.natappfree.cc/tfjy/qa.html\""
                + "}]"
        		+ "},"
        		+ "{"
        		+ "\"name\":\"我的排名\","
